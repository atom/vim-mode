...
class VimState
  ...
  setupCommandMode: ->
    ...
    @registerOperationCommands
      ...
      'move-left': => new Motions.MoveLeft(@editorElement, @)
      'move-up': => new Motions.MoveUp(@editorElement, @)
      'move-down': => new Motions.MoveDown(@editorElement, @)
      'move-right': => new Motions.MoveRight(@editorElement, @)
      'move-to-next-word': => new Motions.MoveToNextWord(@editorElement, @)
      'move-to-next-whole-word': => new Motions.MoveToNextWholeWord(@editorElement, @)
      'move-to-end-of-word': => new Motions.MoveToEndOfWord(@editorElement, @)
      'move-to-end-of-whole-word': => new Motions.MoveToEndOfWholeWord(@editorElement, @)
      'move-to-previous-word': => new Motions.MoveToPreviousWord(@editorElement, @)
      'move-to-previous-whole-word': => new Motions.MoveToPreviousWholeWord(@editorElement, @)
      'move-to-next-paragraph': => new Motions.MoveToNextParagraph(@editorElement, @)
      'move-to-previous-paragraph': => new Motions.MoveToPreviousParagraph(@editorElement, @)
      'move-to-first-character-of-line': => new Motions.MoveToFirstCharacterOfLine(@editorElement, @)
      'move-to-first-character-of-line-and-down': => new Motions.MoveToFirstCharacterOfLineAndDown(@editorElement, @)
      'move-to-last-character-of-line': => new Motions.MoveToLastCharacterOfLine(@editorElement, @)
      'move-to-beginning-of-line': (e) => @moveOrRepeat(e)
      'move-to-first-character-of-line-up': => new Motions.MoveToFirstCharacterOfLineUp(@editorElement, @)
      'move-to-first-character-of-line-down': => new Motions.MoveToFirstCharacterOfLineDown(@editorElement, @)
      'move-to-start-of-file': => new Motions.MoveToStartOfFile(@editorElement, @)
      'move-to-line': => new Motions.MoveToAbsoluteLine(@editorElement, @)
