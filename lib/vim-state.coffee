...
class VimState
  ...
  setupCommandMode: ->
    ...
    @registerOperationCommands
      ...
      'scroll-to-screen-top': => new Scroll.ScrollToScreenTop(@editorView, @editor)
      'scroll-to-screen-middle': => new Scroll.ScrollToScreenMiddle(@editorView, @editor)
      'scroll-to-screen-bottom': => new Scroll.ScrollToScreenBottom(@editorView, @editor)
