...
class VimState
  ...
  setupCommandMode: ->
    ...
    @registerOperationCommands
      ...
      'select-a-double-quotes': => new TextObjects.SelectInsideQuotes(@editor, '"', true)
      'select-a-single-quotes': => new TextObjects.SelectInsideQuotes(@editor, '\'', true)
      'select-a-curly-brackets': => new TextObjects.SelectInsideBrackets(@editor, '{', '}', true)
      'select-a-angle-brackets': => new TextObjects.SelectInsideBrackets(@editor, '<', '>', true)
      'select-a-parentheses': => new TextObjects.SelectInsideBrackets(@editor, '(', ')', true)
