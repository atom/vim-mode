...
class VimState
  ...
  setupCommandMode: ->
    @handleCommands
      ...
      'move-to-top-of-screen': => new motions.MoveToTopOfScreen(@editorView)
      'move-to-middle-of-screen': => new motions.MoveToMiddleOfScreen(@editorView)
      'move-to-bottom-of-screen': => new motions.MoveToBottomOfScreen(@editorView)
